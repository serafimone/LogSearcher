...
public class FileReader implements IFileReader {
    ...
    private static class EarlyExitFromFileWindow {
        private final IFileQueryResult fileQueryResult;
        private final boolean skipWindow;

        EarlyExitFromFileWindow( IFileQueryResult fileQueryResult ) {
        ...
        Optional<IFileQueryResult> getFileQueryResult() {
    ...
    public Optional<LinkedList<String>> moveUp(int lines ) {
        ...
        Optional<LinkedList<String>> result = loadFromBottom( lineStarts.getFirst() - 1L, lines, LoadMode.MOVE );
    ...
    public Optional<LinkedList<String>> moveDown( int lines ) {
        ...
        Optional<LinkedList<String>> result = loadFromTop( lineStarts.getLast(), lines, LoadMode.MOVE );
    ...
    @Override
    public IFileQueryResult moveTo( ZonedDateTime dateTime,
    ...
    IFileQueryResult adjustFileWindowToStartAt( int nextLinesSize,
                                               int lineNumber ) {
    ...
    public Optional<LinkedList<String>> refresh() {
        ...
        Optional<LinkedList<String>> fromTop = loadFromTop( initialLine, fileWindowSize, LoadMode.REFRESH );
        if ( fromTop.isPresent() ) {
            ...
            if ( topList.size() < fileWindowSize ) {
                ...
                loadFromBottom( initialLine - 1L, fileWindowSize - topList.size(), LoadMode.MOVE )
